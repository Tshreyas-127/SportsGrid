...
import { useNavigate } from "react-router-dom";     //Booking button


// Images
import aero1 from "../../../assets/images/aerobics1.jpg";
import aero2 from "../../../assets/images/aerobics2.jpg";
import aero3 from "../../../assets/images/aerobics3.jpg";

export default function Aerobics() {
  const navigate = useNavigate();   //Booking button
  ...
  return (
    <>
      ...
      <div style={heroSection}>
        <h1 style={heroText}>Aerobics</h1>
      </div>

      {/* IMAGE GALLERY */}
      <div style={container}>
        <div style={gallery}>
          <img src={aero1} alt="Aerobics Hall" style={galleryImg} />
          <img src={aero2} alt="Aerobics Session" style={galleryImg} />
          <img src={aero3} alt="Group Aerobics" style={galleryImg} />
        </div>
        ...
        <div style={timingSection}>
          ...
          <p>06:00 to 12:00 hours</p>

          <p style={{ marginTop: "15px" }}><strong>Evening:</strong></p>
          <p>18:30 to 22:30 hours</p>

          <p style={{ marginTop: "20px" }}><strong>Sat – Sun & Holidays</strong></p>
          {/* <p>06:00 to 12:00 hours</p>
          <p>18:30 to 22:30 hours</p> */}
