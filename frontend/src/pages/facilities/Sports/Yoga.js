...
// Images
import y1 from "../../../assets/images/yoga1.jpg";
import y2 from "../../../assets/images/yoga2.avif";
import y3 from "../../../assets/images/yoga3.jfif";
  ...
  return (
    <>
      ...
      <div style={heroSection}>
        <h1 style={heroText}>Yoga</h1>
      </div>

      {/* IMAGE GALLERY */}
      <div style={container}>
        <div style={gallery}>
          <img src={y1} alt="Yoga" style={galleryImg} />
          <img src={y2} alt="Yoga" style={galleryImg} />
          <img src={y3} alt="Yoga" style={galleryImg} />
        </div>
