...
// Images
import pist1 from "../../../assets/images/badminton1.jpg";
import pist2 from "../../../assets/images/badminton2.jpg";
import pist3 from "../../../assets/images/badminton3.jpg";

export default function PistolShooting() {
  ...
  return (
    <>
      ...
      <div style={heroSection}>
        <h1 style={heroText}>Pistol-Shooting</h1>
      </div>

      {/* IMAGE GALLERY */}
      <div style={container}>
        <div style={gallery}>
          <img src={pist1} alt="Badminton Court" style={galleryImg} />
          <img src={pist2} alt="Badminton Match" style={galleryImg} />
          <img src={pist3} alt="Indoor Badminton" style={galleryImg} />
        </div>
