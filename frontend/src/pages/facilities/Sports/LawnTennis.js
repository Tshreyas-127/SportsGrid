...
// Images
import l1 from "../../../assets/images/lawn1.jpg";
import l2 from "../../../assets/images/lawn2.avif";
import l3 from "../../../assets/images/lawn3.jpg";
  ...
  return (
    <>
      ...
      <div style={heroSection}>
        <h1 style={heroText}>Lawn Tennis</h1>
      </div>

      {/* IMAGE GALLERY */}
      <div style={container}>
        <div style={gallery}>
          <img src={l1} alt="Lawn Tennis" style={galleryImg} />
          <img src={l2} alt="Lawn Tennis" style={galleryImg} />
          <img src={l3} alt="Lawn Tennis" style={galleryImg} />
        </div>
