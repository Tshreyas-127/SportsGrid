...
// Images
import bad1 from "../../../assets/images/badminton1.jpg";
import bad2 from "../../../assets/images/badminton2.jpg";
import bad3 from "../../../assets/images/badminton3.jpg";
  ...
  return (
    <>
      ...
      <div style={heroSection}>
        <h1 style={heroText}>Badminton</h1>
      </div>

      {/* IMAGE GALLERY */}
      <div style={container}>
        <div style={gallery}>
          <img src={bad1} alt="Badminton Court" style={galleryImg} />
          <img src={bad2} alt="Badminton Match" style={galleryImg} />
          <img src={bad3} alt="Indoor Badminton" style={galleryImg} />
        </div>
