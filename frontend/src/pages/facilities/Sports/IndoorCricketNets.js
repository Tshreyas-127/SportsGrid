...
// Images
import indoor1 from "../../../assets/images/indoor1.webp";
import indoor2 from "../../../assets/images/indoor2.jfif";
import indoor3 from "../../../assets/images/indoor3.jpg";

export default function IndoorCricketNets() {
  ...
  return (
    <>
      ...
      <div style={heroSection}>
        <h1 style={heroText}>Indoor Cricket Nets</h1>
      </div>

      {/* IMAGE GALLERY */}
      <div style={container}>
        <div style={gallery}>
          <img src={indoor1} alt="Indoor Cricket Net" style={galleryImg} />
          <img src={indoor2} alt="Indoor Cricket Net" style={galleryImg} />
          <img src={indoor3} alt="Indoor Cricket Net" style={galleryImg} />
        </div>
